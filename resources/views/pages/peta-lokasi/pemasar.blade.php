            ...
            <div class="bg-blue-600 text-white rounded-t-xl shadow-lg">
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-wrap justify-center items-center gap-2 p-3">
                        ...
                        <a href="{{ route('peta-lokasi.pengolah') }}" class="px-4 py-2 sm:px-8 sm:py-3 font-semibold text-white hover:bg-blue-700 rounded-lg transition-all sm:whitespace-nowrap">
                            Peta Interaktif Pengolah
                        </a>
                        <!-- Tab Aktif: Pemasar -->
                        <a href="{{ route('peta-lokasi.pemasar') }}" class="px-4 py-2 sm:px-8 sm:py-3 font-bold bg-white text-blue-700 rounded-lg shadow-md sm:whitespace-nowrap">
