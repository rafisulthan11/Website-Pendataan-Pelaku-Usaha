    ...
    <div class="py-6">
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-4 sm:p-6">
                <h3 class="text-3xl font-extrabold text-center mb-6 text-slate-900">Grafik Harga Komoditas</h3>
                    ...
                    <div class="mb-4">
                        <div class="flex justify-center sm:justify-end">
                            ...
                            @endphp
                            <form method="GET" action="{{ route('grafik.tren.harga.komoditas') }}" class="flex flex-col sm:flex-row sm:items-center gap-3 w-full sm:w-auto">
                    ...
                    <div class="w-full h-64 sm:h-80 md:h-[420px]">
                        <canvas id="chartTren" class="w-full h-full"></canvas>
                    </div>
                </div>
            </div>
            </div>
