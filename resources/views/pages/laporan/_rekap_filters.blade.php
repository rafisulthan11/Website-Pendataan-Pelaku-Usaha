    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 items-start gap-3">
        ...
        <div class="lg:col-span-9">
            <div class="flex flex-col sm:flex-row sm:flex-wrap sm:items-center sm:justify-end gap-2">
                ...
                <select name="{{ $komoditas_name ?? 'komoditas' }}" class="px-3 h-9 min-w-[140px] border rounded bg-white text-sm pr-8">
                ...
                <select name="kategori" class="px-3 h-9 min-w-[140px] border rounded bg-white text-sm pr-8">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('laporan.rekapitulasi.pembudidaya') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-700 rounded text-sm">Reset</a>
                </div>
            </div>
        </div>
    </div>
